...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Hardcoded: security_fix_v2 intent — never exposed to client
    const body: Record<string, unknown> = {
      message: prompt,
      intent: "security_fix_v2",
      chat_only: false,
      view: "security",
      view_description: "User is viewing the security panel for the application.",
    };
    ...
    console.error("send-security-fix error:", err);
