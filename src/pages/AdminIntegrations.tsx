...
const PROVIDERS = {
  ...
  github: {
    ...
    description: "Integração GitHub — OAuth App para Venus™. Push de código, tasks e PRDs.",
    fields: [
      { key: "api_key", label: "Client ID", placeholder: "Iv1.abc123...", secret: false },
      { key: "client_secret", label: "Client Secret", placeholder: "ghp_...", secret: true },
    ],
    rateDoc: "https://docs.github.com/en/apps/oauth-apps",
    limitInfo: "Sem limite fixo. Cada usuário autentica via OAuth e usa seu token.",
  },
  openai: {
    name: "OpenAI",
    icon: Brain,
    ...
    description: "GPT, DALL-E e Whisper. Usado como fallback e em funcionalidades específicas.",
    fields: [{ key: "api_key", label: "API Key", placeholder: "sk-...", secret: true }],
    rateDoc: "https://platform.openai.com/docs",
    limitInfo: "Pay-as-you-go. Configure daily_limit conforme seu orçamento.",
  },
  anthropic: {
    ...
    description: "Claude — IA avançada para análise de código e raciocínio complexo.",
    fields: [{ key: "api_key", label: "API Key", placeholder: "sk-ant-...", secret: true }],
    rateDoc: "https://docs.anthropic.com",
    limitInfo: "Pay-as-you-go. Recomendado: daily_limit conforme orçamento.",
  },
  vercel: {
    name: "Vercel",
    icon: Globe,
    ...
    badge: "bg-sky-500/20 text-sky-600",
    description: "Deploy secundário — vincula repos para deploys contínuos via Cirius.",
    fields: [{ key: "api_key", label: "API Token", placeholder: "Bearer ...", secret: true }],
    rateDoc: "https://vercel.com/docs/rest-api",
    limitInfo: "Token pessoal ou de equipe. Sem limite fixo de requisições.",
  },
  netlify: {
    name: "Netlify",
    icon: Globe,
    ...
    description: "Hosting principal — OAuth App para deploy automático via Cirius.",
    fields: [
      { key: "api_key", label: "Client ID", placeholder: "abc123...", secret: false },
      { key: "client_secret", label: "Client Secret", placeholder: "...", secret: true },
    ],
    rateDoc: "https://docs.netlify.com/api/get-started/",
    limitInfo: "OAuth App. Cada usuário autentica via OAuth e usa seu token.",
  },
  supabase_ext: {
    ...
    bg: "bg-emerald-500/10 border-emerald-400/30",
    badge: "bg-emerald-500/20 text-emerald-600",
    description: "Conexão com projetos Supabase externos — aplica migrations SQL via Cirius.",
    fields: [
      { key: "api_key", label: "Service Role Key", placeholder: "eyJhbGci...", secret: true },
      { key: "project_url", label: "Project URL", placeholder: "https://xxxxx.supabase.co", secret: false },
    ],
    rateDoc: "https://supabase.com/docs/guides/api",
    limitInfo: "Service Role tem acesso total. Use com cuidado.",
  },
  custom: {
    name: "Custom",
    icon: Key,
    ...
    description: "Chave genérica para qualquer serviço externo não listado acima.",
    fields: [{ key: "api_key", label: "API Key / Token", placeholder: "...", secret: true }],
    rateDoc: "",
    limitInfo: "Configure limites conforme a documentação do serviço.",
  },
} as const;
