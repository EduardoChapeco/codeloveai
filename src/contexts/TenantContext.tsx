...
// Safe columns — excludes mp_access_token and other sensitive fields
const TENANT_SAFE_COLS = "id,name,slug,domain,domain_custom,is_domain_approved,status,is_active,primary_color,secondary_color,accent_color,logo_url,favicon_url,font_family,border_radius,theme_preset,commission_percent,plan_type,token_cost,trial_minutes,modules,branding,extension_mode,custom_mode_prompt,meta_title,meta_description,terms_template,owner_user_id,affiliate_id,white_label_plan_id,setup_paid,setup_paid_at,platform_fee_per_user,global_split_percent,affiliate_global_split_percent,created_at,updated_at";
    ...
    const loadTenant = async () => {
      try {
        ...
        const tenantPromise = supabase
          .from("tenants").select(TENANT_SAFE_COLS)
