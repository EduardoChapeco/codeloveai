      ...
      <div className="sb-body">
        {inAdminContext && (isAdmin || isTenantAdmin) ? (
          ...
          <>
            ...
            <NavEntry to="/painel" label="Painel" icon={Plug} iconColor="ib-teal" active={isActive("/painel") || isActive("/lovable/connect") || (location.pathname === "/home")} collapsed={collapsed} />
